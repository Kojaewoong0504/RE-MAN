      ...
      {selectedItem ? (
        <section className="closet-detail-drawer">
          <div>
            ...
            {[selectedItem.fit, selectedItem.size, selectedItem.wear_state, selectedItem.notes]
              .filter(Boolean)
              .length > 0 ? (
              <p>
                {[selectedItem.fit, selectedItem.size, selectedItem.wear_state, selectedItem.notes]
        ...
        <div className="closet-modal-backdrop" role="presentation">
          ...
          >
            <div className="closet-modal-header">
              <div>
                <p className="poster-kicker">Add</p>
                <h2>옷 추가</h2>
              </div>
              <button
                aria-label="닫기"
            ...
            <button
              ...
              type="button"
            >
              <span>{photoDataUrl ? "사진을 옷장에 추가" : "사진을 먼저 선택"}</span>
              <span>+</span>
            </button>
          </section>
        </div>
